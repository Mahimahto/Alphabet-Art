...
//Add Sound on click in Gallery Button
let galleryButton = document.querySelector(".gallery")
galleryButton.addEventListener("click", function () {
    galleryButton = new Audio(`assets/clickOnSound/gallerySound.mp3`)
    galleryButton.play()
})

//Add sound on click in Submit Button
let submitButton = document.querySelector(".call-to-action")
submitButton.addEventListener("click", function () {
    galleryButton = new Audio(`assets/clickOnSound/submitSound.mp3`)
    galleryButton.play()
})
...
for (let i = 65; i <= 90; i++) {
    ...
    //Add heart sound on click
    let likeSound = new Audio('assets/clickOnSound/likeSound.wav')
